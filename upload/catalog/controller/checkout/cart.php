...
//				unset($this->session->data['payment_methods']);
    ...
    public function checkout(){
        ...
        $s_data['payment_address']['country_id'] = $this->request->post['country_id'];
        ...
        $s_data['shipping_address']['country_id'] = $this->request->post['country_id'];
        ...
        array_multisort($sort_order, SORT_ASC, $method_data);
        // 获取第一个
        $s_data['shipping_method'] = current($method_data);
       ...
       // if ($this->cart->hasShipping()) {
            ...
            $order_data['shipping_address_1'] = $s_data['shipping_address']['address_1'];
            $order_data['shipping_address_2'] = $s_data['shipping_address']['address_2'];
            $order_data['shipping_city'] = $s_data['shipping_address']['city'];
            $order_data['shipping_postcode'] = $s_data['shipping_address']['postcode'];
            $order_data['shipping_zone'] = $s_data['shipping_address']['zone'];
            $order_data['shipping_zone_id'] = $s_data['shipping_address']['zone_id'];
            $order_data['shipping_country'] = $s_data['shipping_address']['country'];
            $order_data['shipping_country_id'] = $s_data['shipping_address']['country_id'];
            $order_data['shipping_address_format'] = $s_data['shipping_address']['address_format'];
            $order_data['shipping_custom_field'] = (isset($s_data['shipping_address']['custom_field']) ? $s_data['shipping_address']['custom_field'] : array());

            if (isset($s_data['shipping_method']['title'])) {
                $order_data['shipping_method'] = $s_data['shipping_method']['title'];
            } else {
                $order_data['shipping_method'] = '';
            }

            if (isset($s_data['shipping_method']['code'])) {
                $order_data['shipping_code'] = $s_data['shipping_method']['code'];
            } else {
                $order_data['shipping_code'] = '';
            }
//        } else {
...
//        }
        ...
        // 保存订单
        $s_data['order_id'] = $this->model_checkout_order->addOrder($order_data);


        $data['payment'] = $this->load->controller('extension/payment/' . $s_data['payment_method']['code']);
