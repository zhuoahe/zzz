    ...
    <ul>
      ...
      <li>
        <div class="totals">
          ...
          <p class="text-right"><a class="hidden"></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo $cart; ?>"><strong><i class="fa fa-share"></i> <?php echo $text_checkout; ?></strong></a></p>
        </div>
      </li>
      <?php } else { ?>
      <li>
        <p class="text-center emptyCart"><?php echo $text_empty; ?></p>
      </li>
      <?php } ?>
    </ul>
  </div>
